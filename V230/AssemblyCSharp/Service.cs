    ...
    public void gotoPlayer(int id, bool isAutoUseYardrat = true)
    {
        if (isAutoUseYardrat) new Thread(delegate ()
        {
            ...
            if (Char.myCharz().arrItemBody[5] == null || (Char.myCharz().arrItemBody[5] != null
                && ((Char.myCharz().arrItemBody[5].template.id < 591 || Char.myCharz().arrItemBody[5].template.id > 594)
                            && Char.myCharz().arrItemBody[5].template.id != 905 && Char.myCharz().arrItemBody[5].template.id != 907
                            && Char.myCharz().arrItemBody[5].template.id != 911)))
            {
                ...
                for (int i = 0; i < Char.myCharz().arrItemBag.Length; i++)
                {
                    ...
                    if (item != null && ((item.template.id >= 591 && item.template.id <= 594) || item.template.id == 905 || item.template.id == 907 || item.template.id == 911))
                    {
                        do
                        {
                            getItem(4, (sbyte)i);
                        ...
                        while ((Char.myCharz().arrItemBody[5].template.id < 591 || Char.myCharz().arrItemBody[5].template.id > 594)
                            && Char.myCharz().arrItemBody[5].template.id != 905 && Char.myCharz().arrItemBody[5].template.id != 907
                            && Char.myCharz().arrItemBody[5].template.id != 911
                        );
                        break;
