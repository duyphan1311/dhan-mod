...
namespace Mod.ModMenu
{
    public class ModMenuMain : IChatable
    {
        ...
        public static ModMenuItemInt[] modMenuItemInts = new ModMenuItemInt[]
        {
            ...
            new ModMenuItemInt("Mode tàn sát", new string[]{"Di chuyển đánh quái", "Tele đánh quái", "Tàn sát người chơi", "Auto đánh boss"}, "", 0, PickMobController.setState, "modetansat"),
