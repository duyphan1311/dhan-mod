...
namespace Mod.TeleportMenu
{
    public class TeleportMenu : IChatable
    {
        ...
        [ChatCommand("tele"), HotkeyCommand('q')]
        ...
        public static void doFireTeleportListPanel(Panel panel)
        {
                ...
                case TeleportStatus.Delete:
                    ...
                    action = () =>
                    {
                        if (teleportChar != charAutoTeleportTo)
                        {
                            ...
                            setTabTeleportListPanel(GameCanvas.panel);
                        }
            ...
            int anyNum = rnd.Next(1, 12);

            panel.partID = new int[] { parts[anyNum].head, parts[anyNum].leg, parts[anyNum].body };
        ...
        private class PartMod
        {
            ...
            public PartMod(int head, int leg, int body)
            {
                this.head = head;
                this.leg = leg;
                this.body = body;
        ...
        private static Dictionary<int, PartMod> parts = new()
        {
            { 1, new PartMod { head = 2036, leg = 2038, body = 2037 } },
            { 2, new PartMod { head = 2103, leg = 2105, body = 2104 } },
            { 3, new PartMod { head = 2109, leg = 2111, body = 2110 } },
            { 4, new PartMod { head = 2042, leg = 2044, body = 2043 } },
            { 5, new PartMod { head = 2081, leg = 2083, body = 2082 } },
            { 6, new PartMod { head = 2106, leg = 2108, body = 2107 } },
            { 7, new PartMod { head = 2142, leg = 2144, body = 2143 } },
            { 8, new PartMod { head = 627, leg = 629, body = 628 } },
            { 9, new PartMod { head = 2115, leg = 2117, body = 2116 } },
            { 10, new PartMod { head = 630, leg = 632, body = 631 } },
            { 11, new PartMod { head = 2075, leg = 2077, body = 2076 } },
            { 12, new PartMod { head = 2030, leg = 2032, body = 2031 } }
        };
        ...
        public static void TeleportToPlayer(int charId, bool isAutoUseYardrat = true)
        {
