...
public class mFont
{
    ...
    public static mFont nameFontYellow2;
    ...
    public static void init()
    {
        if (mGraphics.zoomLevel == 1)
        {
            ...
            nameFontYellow2 = tahoma_7_yellow;
        ...
        tahoma_7b_orange = new mFont(32);
        nameFontRed = tahoma_7b_red;
        nameFontYellow = tahoma_7_yellow;
        nameFontGreen = tahoma_7_green;
        nameFontOrange = tahoma_7b_orange;
        nameFontYellow2 = new mFont(33);
        tahoma_7_greySmall = tahoma_7_grey;
        tahoma_7b_yellowSmall2 = tahoma_7_yellow;
        tahoma_7b_green2Small = tahoma_7b_green2;
        tahoma_7_whiteSmall = tahoma_7_white;
    ...
    {
        if (long.TryParse(st.Substring(1), out long res))
        {
            st = st.Substring(0, 1) + NinjaUtil.getMoneys(res);
        }
        if (mGraphics.zoomLevel == 1)
