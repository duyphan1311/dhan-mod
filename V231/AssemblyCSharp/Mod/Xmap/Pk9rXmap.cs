...
namespace Mod.Xmap
{
    public class Pk9rXmap
    {
        ...
        public static void showXmapMenu()
        {
            ...
            XmapData.loadGroupMapsFromFile("Data\\XMapData\\GroupMapsXmap.txt");
        ...
        public static void showXmapPanel(List<int> maps)
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                {
                    if (maps[i] >= 78) nameMap = TileMap.mapNames[maps[i] - 1];
                    if (maps[i] >= 94) nameMap = TileMap.mapNames[maps[i] - 2];
                    if (maps[i] >= 99) nameMap = TileMap.mapNames[maps[i] - 3];
                }
                #endregion
                var mapId = maps[i];
        ...
        public static void Info(string text)
        {
            if (XmapController.gI.IsActing)
            {
                var keywords = new List<string>
                {
                    ...
                    "Vui lòng hoàn thành nhiệm vụ trước khi tới đây!",
                };
        ...
        public static bool canUseCapsule()
        {
            return !Utilities.isMyCharDied() && (Utilities.hasItemCapsuleVip() || Utilities.hasItemCapsuleNormal());
        }
        ...
        public static void nextMapNpcMenu(MapNext mapNext)
        {
            ...
            Utilities.openMenu((sbyte)npcId);
