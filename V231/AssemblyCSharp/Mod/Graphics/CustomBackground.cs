...
namespace Mod.Graphics
{
    public class CustomBackground : IChatable
    {
        ...
        public static void LoadData()
        {
            try
            {
                foreach (string path in Utilities.loadCustomPathRMSString("custombackgroundpath").Split('|'))
                {
                ...
                backgroundIndex = Utilities.isFirstTimeLoad ? 0 : Utilities.loadRMSInt("backgroundindex");
        ...
        public static void SaveData()
        {
            ...
            Utilities.saveCustomPathRMSString("custombackgroundpath", data);
        ...
        public static int bgIndex() => backgroundIndex; 
    }
}
