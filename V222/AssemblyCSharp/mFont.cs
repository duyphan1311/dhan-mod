...
public class mFont
{
	...
	public static mFont number_blue;
	...
	public static mFont bigNumber_red2;
	...
	public static mFont nameFontRed2;

	public static mFont nameFontOrange;
	...
	public static void init()
	{
		if (mGraphics.zoomLevel == 1)
		{
			...
			tahoma_7b_red2 = new mFont(" 0123456789+-*='_?.,<>/[]{}!@#$%^&*():aáàảãạâấầẩẫậăắằẳẵặbcdđeéèẻẽẹêếềểễệfghiíìỉĩịjklmnoóòỏõọôốồổỗộơớờởỡợpqrstuúùủũụưứừửữựvxyýỳỷỹỵzwAÁÀẢÃẠĂẰẮẲẴẶÂẤẦẨẪẬBCDĐEÉÈẺẼẸÊẾỀỂỄỆFGHIÍÌỈĨỊJKLMNOÓÒỎÕỌÔỐỒỔỖỘƠỚỜỞỠỢPQRSTUÚÙỦŨỤƯỨỪỬỮỰVXYÝỲỶỸỴZW", "/myfont/tahoma_7b_red.png", "/myfont/tahoma_7b", 0);
			tahoma_7b_orange = new mFont(" 0123456789+-*='_?.,<>/[]{}!@#$%^&*():aáàảãạâấầẩẫậăắằẳẵặbcdđeéèẻẽẹêếềểễệfghiíìỉĩịjklmnoóòỏõọôốồổỗộơớờởỡợpqrstuúùủũụưứừửữựvxyýỳỷỹỵzwAÁÀẢÃẠĂẰẮẲẴẶÂẤẦẨẪẬBCDĐEÉÈẺẼẸÊẾỀỂỄỆFGHIÍÌỈĨỊJKLMNOÓÒỎÕỌÔỐỒỔỖỘƠỚỜỞỠỢPQRSTUÚÙỦŨỤƯỨỪỬỮỰVXYÝỲỶỸỴZW", "/myfont/tahoma_7b_yellow.png", "/myfont/tahoma_7b", 0);
		...
		number_blue = new mFont(21);
		number_black = new mFont(22);
		number_white = new mFont(23);
		number_red = new mFont(24);
		number_green = new mFont(26);
		number_gray = new mFont(27);
		number_orange = new mFont(28);
		bigNumber_red = new mFont(29);
		bigNumber_yellow = new mFont(30);
		bigNumber_green = new mFont(31);
		bigNumber_While = new mFont(32);
		bigNumber_blue = new mFont(33);
		bigNumber_orange = new mFont(34);
		bigNumber_black = new mFont(35);
		bigNumber_red2 = new mFont(36);
		tahoma_7b_red2 = new mFont(25);
		tahoma_7b_orange = new mFont(28);
		nameFontRed = new mFont(24);
		nameFontYellow = tahoma_7_yellow;
		nameFontGreen = new mFont(37);
		nameFontRed2 = tahoma_7b_red2;
		nameFontOrange = tahoma_7b_orange;
		tahoma_7_greySmall = tahoma_7_grey;
		tahoma_7b_yellowSmall2 = tahoma_7_yellow;
		tahoma_7b_green2Small = tahoma_7b_green2;
		tahoma_7_whiteSmall = tahoma_7_white;
