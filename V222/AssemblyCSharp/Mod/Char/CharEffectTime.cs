...
namespace Mod
{
    public class CharEffectTime
    {
        ...
        public bool isCharExplode;

        public int timeExplode;

        public long lastimeExplode;

        public void Update()
        {
            if (timeExplode > 0 && mSystem.currentTimeMillis() - lastimeExplode >= 1000)
            {
                timeExplode--;
                lastimeExplode = mSystem.currentTimeMillis();
            }
