...
namespace AssemblyCSharp.Mod.Xmap
{
    public class XmapData
    {
        ...
        private void LoadLinkMapBase()
        {
            ...
            LoadLinkMapsFromFile("Game\\TextData\\LinkMapsXmap.txt");
            LoadLinkMapsAutoWaypointFromFile("Game\\TextData\\AutoLinkMapsWaypoint.txt");
            LoadLinkMapsHome();
            LoadLinkMapSieuThi();
            LoadLinkMapToCold();
        }
        ...
        {
            return GetIdMapFromName(mapName);
        }
