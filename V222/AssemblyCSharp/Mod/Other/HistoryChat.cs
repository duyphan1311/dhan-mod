...
namespace AssemblyCSharp.Mod.Other
{
    public class HistoryChat
    {
        ...
        /// <summary>
        /// Đường dẫn file chat cũ.
        /// </summary>
        private string PathChatHistory = "Data\\ChatHistory.txt";
        ...
        public void append(string text)
        {
            ...
            try
            {
                histories = LitJson.JsonMapper.ToObject<List<string>>(
                        File.ReadAllText(PathChatHistory));
            }
            catch { }
            ...
            try
            {
                File.WriteAllText(PathChatHistory,
        ...
        public void paint(mGraphics g)
        {
            ...
            mFont.tahoma_7_whiteSmall.drawString(g, "Gần đây", x + 5, y, 0);
            if (this.chatBack != hints[selectedIndex])
            {
                int x = this.x + this.width - mFont.tahoma_7_whiteSmall.getWidth("Nhấn Tab để lựa chọn") - 5;
                mFont.tahoma_7_whiteSmall.drawString(g, "Nhấn Tab để lựa chọn", x, y, 0);
            }
            ...
            {
                mFont.tahoma_7_whiteSmall.drawString(g, hints[i], x + 5, y + HEIGHT_HINT_ITEM + HEIGHT_HINT_ITEM * (i - scrollValue), 0);
            }
        }
